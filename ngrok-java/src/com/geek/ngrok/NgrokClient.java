...
public class NgrokClient {
	...
	public void start() {
		...
		// 发送登录认证
		try {
			MsgSend.SendAuth(authtoken, clientToken, s.getOutputStream());
			// 启动线程监听
	...
	public void addTun(String localhost, int localport, String Protocol, String Hostname, String Subdomain,
